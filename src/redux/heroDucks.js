...
export const obtenerHeroesAccion = () => async (dispatch, getState) => {
    ...
    try {
        const res = await axios.get(`http://gateway.marvel.com/v1/public/characters?limit=8&offset=${offset}&ts=1&apikey=344d40df0c8cc373141c1dc321fae9cf&hash=bd0722d5750b6362d5ba0212ca36726b`)
...
export const siguienteHeroeAccion = () => async (dispatch, getState) => {
    ...
    try {
        const res = await axios.get(`http://gateway.marvel.com/v1/public/characters?limit=8&offset=${siguiente}&ts=1&apikey=344d40df0c8cc373141c1dc321fae9cf&hash=bd0722d5750b6362d5ba0212ca36726b`)
        dispatch({
